...
//    "-Xfatal-warnings", // Fail the compilation if there are any warnings. @todo look at re-enabling later
    ...
    "-Xlint:implicit-recursion", // Warn when more than one implicit parameter section is defined.
    ...
    "-Wunused:linted",
//    "-Wvalue-discard", // Warn when non-Unit expression results are unused. @todo Lokk to re-enable
